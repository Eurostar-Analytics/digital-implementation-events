...
window.expectedTealiumViewObjects = [
  {
    ...
    product_price: [/^\d+\.\d{2}$/],
    product_price_inpoints: [/^(\d+|null|undefined)$/],
    product_brand: [/^(ES|ER|SN|SNCB)$/], // e.g., ES, ER
    product_category: ["trains"],
    product_variant: [/^(outbound|inbound|null)$/],
    product_departure_date: [/^\d{4}-\d{2}-\d{2}|null$/],
    product_return_date: [/^(\d{4}-\d{2}-\d{2}|null|undefined)$/],
    product_train_class: [/^(Eurostar Standard|Eurostar Plus|Eurostar Premier|Standard Seconde|Standard Seconde|Standard Première|Flex Première|Standard|Wheelchair|PREMIÈRE SIGNATURE|PREMIÈRE|Standard Premier|Comfort|Business Premier|Premium|BUSINESS 1ÈRE|STANDARD 1ÈRE)$/],
    product_train_route: [/^(london route|continent route)$/],
    product_train_origin_stationcode: [/^\d{7}$/],
    product_train_destination_stationcode: [/^\d{7}$/],
    product_train_number: [/^\d{4}$/],
    ...
    product_train_numberofconnections: [/^\d+$/],
    product_train_connectionoperator: [/^(null|Eurostar|SNCF)?$/],
    product_train_tickettype: [/^(ESTAR_PUB_(STD|PLUS|PREM)|SNCF1SF|RED_ESTAR_PUB_PLUS|LYRIA2NF|SNCF2SF|null)$/],
    product_train_passenger_type: [/^(adult|null)$/],
    product_train_sale_tag: [/^(lowest fare|limited seats.*|null)?$/],
    product_travel_date: [/^\d{4}-\d{2}-\d{2}$/],
    product_train_fare_name: [/^(through fare|summated fare|null)?$/],
...
},
{
	...
	pnr: /^[A-Z0-9]{6}$/, 
	order_id: /^([0-9]{8}[a-z]{6})(\:upgrade|\:exchage)?$/,
	order_revenue: /^\d+\.\d{2}$/,
	order_revenue_inpoints: /^\d+$/,
	purchase_hashedemail: /^.{0,64}$/,
	...
	paymentCardType: /^(mc|visa|amex)$/,
	payment_status: /^(confirmed|pending)$/,
	loyalty_points_discount_usage: /^(true|false)$/,
...
},
{
	...
	product_train_tickettype: [/^(ESTAR_PUB_(STD|PLUS|PREM)|SNCF1SF|RED_ESTAR_PUB_PLUS|null)$/],
	product_train_passenger_type: [/^(adult|child|infant|null)$/],
	...
	product_hotel_room_extra: [/^(room only|null)$/],
	product_hotel_promotion: [/^(none|.*)$/],
